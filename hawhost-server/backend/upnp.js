...
/**
 * Minimal UPnP Internet Gateway Device client. Everything stays on the local
...
class UpnpClient {
  ...
  async discover({ localAddress, force = false, timeoutMs = 2500 } = {}) {
    ...
    this.lastError = 'No UPnP router found. UPnP may be turned off in the router settings.';
    return null;
  }
  ...
  async addMapping({ externalPort, internalPort, internalClient, protocol = 'TCP', description = 'HawHost', leaseSeconds = 3600, localAddress }) {
